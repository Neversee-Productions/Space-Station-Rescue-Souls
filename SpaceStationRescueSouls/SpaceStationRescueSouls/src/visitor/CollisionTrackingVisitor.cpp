#include "stdafx.h"
#include "CollisionTrackingVisitor.h"
#include "math/Math.h"

app::vis::CollisionTrackingVisitor::CollisionTrackingVisitor(comp::Location const & location, comp::Dimensions const & dimensions)
	: m_location(location)
	, m_dimensions(dimensions)
{
}

void app::vis::CollisionTrackingVisitor::operator()(cute::c2AABB & aabb) const
{
	if constexpr (true)
	{
...
void app::vis::CollisionTrackingVisitor::operator()(cute::c2Circle & circle) const
{
